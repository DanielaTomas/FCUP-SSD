...
\item 
\mbox{\hyperlink{classKademlia_1_1ClientHandler_a6a6c7a942ca001f87f5c51be113a8f57}{Client\+Handler}} (\mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}} node\+Info, \mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}} target\+Node\+Info, String key, \mbox{\hyperlink{classKademlia_1_1ValueWrapper}{Value\+Wrapper}} value, \mbox{\hyperlink{enumKademlia_1_1Kademlia_1_1MessageType}{Kademlia.\+Message\+Type}} message\+Type, List$<$ \mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}} $>$ near\+Nodes\+Info)
\item 
...
\mbox{\Hypertarget{classKademlia_1_1ClientHandler_a6a6c7a942ca001f87f5c51be113a8f57}\label{classKademlia_1_1ClientHandler_a6a6c7a942ca001f87f5c51be113a8f57}} 
...
{\footnotesize\ttfamily Kademlia.\+Client\+Handler.\+Client\+Handler (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}}}]{node\+Info,  }\item[{\mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}}}]{target\+Node\+Info,  }\item[{String}]{key,  }\item[{\mbox{\hyperlink{classKademlia_1_1ValueWrapper}{Value\+Wrapper}}}]{value,  }\item[{\mbox{\hyperlink{enumKademlia_1_1Kademlia_1_1MessageType}{Kademlia.\+Message\+Type}}}]{message\+Type,  }\item[{List$<$ \mbox{\hyperlink{classKademlia_1_1NodeInfo}{Node\+Info}} $>$}]{near\+Nodes\+Info }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
